...
public class RegexToDfa {
    ...
    public static void initialize() {
        ...
        for (String word : words) {
            ...
            if (acc) {
                System.out.println((char) 27 + "[32m" + "this string is acceptable by the regex!" + word);
            } else {
                System.out.println((char) 27 + "[31m" + "this string is not acceptable by the regex!"+word);
            }
        }
